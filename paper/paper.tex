...
\begin{algorithm}[H]
 \KwData{Upfront cost, Per hour charge, Utilisation [hours per day];}
...
\subsection{Daily metrics aggregation}

\subsubsection{Calculate uptime per machine }
...
\subsubsection{Aggregate CPU and memory usage}
...
\subsubsection{Calculate number of jobs per day}
...
\subsubsection{Calculate cluster averages for aggregations}
Input: 
