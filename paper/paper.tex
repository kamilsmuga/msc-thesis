...
\section{Google trace data schema transformation}

We used machine and tasks data for further evaluation. Machine information regarding ID and capacity can be found in machine events  . 
...
- uptime per day
- total CPU usage per day
- total memory usage per day
