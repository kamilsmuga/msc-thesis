...
\end{itemize}
  ...
  \item Mandatory:
    \begin{itemize}
      \item A formal definition of continous capacity planning approach.
      \item A design of an algorithm that calculates an uptime optimality factor of VM utilisation based on a pricing scheme.
    \end{itemize}
  ...
  \item Exceptional
    \begin{itemize}
      \item Generate suggestions to change the configuration based on the calculated results.
    \end{itemize}
